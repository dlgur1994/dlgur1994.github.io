...
$$\bigtriangledown_{\theta} J(\theta) = \left[ \begin{matrix} {\partial J} \over {\partial \theta_{0}} \\ {\partial J} \over {\partial \theta_{1}} \\ \cdots \\ {\partial J} \over {\partial \theta_{n}} \\ \end{matrix} \right] (\theta \in \mathbb{R} ^{n+1})$$

ex) $$A \in \mathbb{R}^{2 \times 2}
<br>
