...
ex) $$A \in \mathbb{R}^{2 \times 2}$$ => $$A = \left[ \begin{matrix} A_{11} A_{12} \\ A_{21} A_22 \\ \end{matrix} \right]$$ $$f: \mathbb{R}^{2 \times 2} -> \mathbb{R}$$  
...
$$\bittriangledown_{A} f(A) = \left[ \begin{matrix} 1 2A_{12} \\ 0 0 \\ \end{matrix} \right]$$  
<br>
