...
$$\bigtriangledown_{\theta} J(\theta) = \left[ \begin{matrix} {\partial J} \over {\partial \theta_{0}} \\ {\partial J} \over {\partial \theta_{1}} \\ {\partial J} \over {\partial \theta_{0}} \\ \end{matrix} \right] (\theta \in \mathbb{R} ^{n+1})$$
