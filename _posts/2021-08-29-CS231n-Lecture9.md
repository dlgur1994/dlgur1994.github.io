...
### GoogLeNet
- ![11](/images/cs231n/lec9/11.png){: width="100%" height="100%"}
...
### ResNet
- ![20](/images/cs231n/lec9/20.png){: width="100%" height="100%"}
...
- architecture
    - ![23](/images/cs231n/lec9/23.png){: width="100%" height="100%"}
        - additional conv layer at the beginning 
    - ![24](/images/cs231n/lec9/24.png){: width="100%" height="100%"}
        - stack residual blocks
        - every residual block has two 3x3 conv layers 
    - ![25](/images/cs231n/lec9/25.png){: width="100%" height="100%"}
        - periodically, double # of filters and downsample F(x) spatially using stride 2 (/2 in each dimension)
    - ![26](/images/cs231n/lec9/26.png){: width="100%" height="100%"}
        - use the global average pooling layer
        - no FC layers at the end (only FC 1000 to output classes)
- ![27](/images/cs231n/lec9/27.png){: width="100%" height="100%"} 
...
- ![32](/images/cs231n/lec9/32.png){: width="100%" height="100%"}
...
- ![33](/images/cs231n/lec9/33.png){: width="100%" height="100%"}
...
- ![35](/images/cs231n/lec9/35.png){: width="100%" height="100%"}
...
- ![37](/images/cs231n/lec9/37.png){: width="100%" height="100%"}
- dense blocks where each layer is connected to every other layer in feedforward fashion
- alleviates vanishing gradient, strengthens feature propagation, encourages feature reuse

### SqueezeNet: AlexNet-level Accuracy With 50x Fewer Parameters and <0.5Mb Model Size
- ![38](/images/cs231n/lec9/38.png){: width="100%" height="100%"}
